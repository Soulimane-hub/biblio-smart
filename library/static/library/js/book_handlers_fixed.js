...
// Fonction pour voir les détails d'un livre (version simplifiée pour débogage)
function viewBookDetails(livreId) {
  ...
  // Utiliser XMLHttpRequest pour plus de contrôle sur les erreurs
  const xhr = new XMLHttpRequest();
  xhr.open('GET', '/book/' + livreId + '/json/', true);
  ...
  xhr.onerror = function() {
    ...
    showNotification('Erreur réseau lors du chargement des détails', 'error');
  };
